...
export default class Camera{
    ...
    createPerspectiveCamera(){
        ...
        this.perspectiveCamera.position.x = 32;
    ...
    createOrthographicCamera(){
        ...
        // (this.sizes.aspect*this.sizes.frustrum)/2, this.sizes.frustrum/2, -this.sizes.frustrum/2, -10, 10);
    ...
    update(){
        ...
        //helps the orthographic camera helper work properly
